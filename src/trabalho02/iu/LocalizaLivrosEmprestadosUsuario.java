 ...
 * @author luskas
 */
public class LocalizaLivrosEmprestadosUsuario extends javax.swing.JDialog {
     ...
     */
    public LocalizaLivrosEmprestadosUsuario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        for (Usuario u: usuarios) {
            for (Emprestimo e : emprestimos) {
                if (e.getCodUsuario().equals(u.getCodUsuario())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LocalizaLivrosEmprestadosUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LocalizaLivrosEmprestadosUsuario dialog = new LocalizaLivrosEmprestadosUsuario(new javax.swing.JFrame(), true);
